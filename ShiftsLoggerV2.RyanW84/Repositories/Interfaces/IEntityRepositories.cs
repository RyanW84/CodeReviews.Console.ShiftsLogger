...
public interface IShiftRepository
    : IRepository<Shift, ShiftFilterOptions, ShiftApiRequestDto, ShiftApiRequestDto>
{
    /// <summary>
    ...
    /// </summary>
    Task<bool> HasOverlappingShiftAsync(
        int workerId,
        int locationId,
...
public interface IWorkerRepository
    : IRepository<Worker, WorkerFilterOptions, WorkerApiRequestDto, WorkerApiRequestDto>
{
    /// <summary>
...
public interface ILocationRepository
    : IRepository<Location, LocationFilterOptions, LocationApiRequestDto, LocationApiRequestDto>
{
    /// <summary>
